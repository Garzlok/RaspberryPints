...
if (isset ( $_POST ['save'] )) {
    ...
    $_POST[ConfigNames::ShowDigitalClock]   = ($_POST["showClockFormat"] == "1" && $_POST["showDigitalClockFormat"] == "1"  && isset($_POST["showClockUpperRight"]))?'1':'0';
    $_POST[ConfigNames::ShowDigitalClock24] = ($_POST["showClockFormat"] == "1" && $_POST["showDigitalClockFormat"] == "-1" && isset($_POST["showClockUpperRight"]))?'1':'0';
    $_POST[ConfigNames::ShowAnalogClock] = ($_POST["showClockFormat"] == "-1" && isset($_POST["showClockUpperRight"]))?'1':'0';
...
<br/>
        ...
        <table style="border: thin;">
        	<tr>
                ...
                <td>
<div id="clocks" <?php if(!$config[ConfigNames::ShowAnalogClock] && !$config[ConfigNames::ShowDigitalClock] && !$config[ConfigNames::ShowDigitalClock24])echo 'class="disabled"'; ?>> 
<div id="analogDisplay" <?php if(!$config[ConfigNames::ShowAnalogClock])echo 'style="display:none"'; ?>>
    <div id="analogClock">
        <canvas id="canvas" width="100" height="100" style="background-color:#0000000"></canvas>
        <script>
...
<div id="digitalDisplay" <?php if($config[ConfigNames::ShowAnalogClock])echo 'style="display:none"'; ?>>
    <div id="digitalClockDiv" <?php if($config[ConfigNames::ShowDigitalClock24])echo 'style="display:none"'; ?>>
    <div id="digitalClock" style="font-size: 24px;width:130px"></div>
    <script>
    ...
    function displayTime(){
  	...
  	<div id="digitalClock24Div" <?php if(!$config[ConfigNames::ShowDigitalClock24])echo 'style="display:none"'; ?>>
        <div id="digitalClock24" style="font-size: 24px;width:130px" ></div>
        <script>
        var clock24 = document.getElementById("digitalClock24");
        displayTime();
        setInterval(displayTime, 1000);
        function displayTime(){
        	var date = new Date();
            ...
            s = (s < 10) ? "0" + s : s;
            var time = h + ":" + m + ":" + s
        	clock24.innerHTML = time;
        }
        </script>
    </div>
                   	
    <input type="radio" name="showDigitalClockFormat" id="DigitalClockSel" value="1"  <?php if(!$config[ConfigNames::ShowDigitalClock24])echo 'checked'?> onchange="if($(this)[0].checked){$('#digitalClockDiv').show();$('#digitalClock24Div').hide();}else{$('#digitalClockDiv').hide();};">12Hr
    <input type="radio" name="showDigitalClockFormat" id="DigitalClockSel" value="-1" <?php if( $config[ConfigNames::ShowDigitalClock24])echo 'checked'?> onchange="if($(this)[0].checked){$('#digitalClock24Div').show();$('#digitalClockDiv').hide();}else{$('#digitalClock24Div').hide();};">24Hr
</div>
<input type="radio" name="showClockFormat" id="ClockFormatSel" value="-1"  <?php if( $config[ConfigNames::ShowAnalogClock])echo 'checked'?> onchange="if($(this)[0].checked){$('#analogDisplay').show();$('#digitalDisplay').hide();}else{$('#analogDisplay').hide();};">Analog<br/>
<input type="radio" name="showClockFormat" id="ClockFormatSel" value="1" <?php if(!$config[ConfigNames::ShowAnalogClock])echo 'checked'?> onchange="if($(this)[0].checked){$('#digitalDisplay').show();$('#analogDisplay').hide();}else{$('#digitalDisplay').hide();};">Digital
<br/>
<input type="checkbox" name="showClockUpperRight" <?php if($config[ConfigNames::ShowAnalogClock] || $config[ConfigNames::ShowDigitalClock] || $config[ConfigNames::ShowDigitalClock24])echo 'checked'; ?> value="1" onchange="$(clocks).toggleClass('disabled');">Visible
</div>
                </td>
                <td>
